...
export const metadata: Metadata = {
  ...
  title: { default: "公益API导航站 — AI 模型公益中转站导航", template: "%s | 公益API导航" },
  description: "收录各种公益、免费、可白嫖的AI大模型API中转站，帮助更多人找到可用、稳定、低门槛的AI服务入口。",
  keywords: ["公益API", "AI中转站", "免费Token", "API导航", "大模型API", "公益导航"],
  openGraph: { type: "website", locale: "zh_CN", siteName: "公益API导航站" },
};
